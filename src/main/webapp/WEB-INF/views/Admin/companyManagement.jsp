...
if (request.getAttribute("companies") != null && !request.getAttribute("companies").equals("")) {
    companies = (List<Companies>) request.getAttribute("companies");
                ...
                <div id="div-forms">
                    <form id="editCom" method="post" autocomplete="off" action="<%= request.getContextPath()%>/admin/submitEditDetails">
		                <div class="modal-body">
                            ...
                            <input id="updateDateOfCampus" name="updateDateOfCampus" class="form-control" type="text" placeholder="Edit Date Of Campus" required>
