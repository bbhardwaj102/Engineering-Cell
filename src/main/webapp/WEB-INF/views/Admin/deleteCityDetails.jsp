...
if (request.getAttribute("delCityDetails") != null && !request.getAttribute("delCityDetails").equals("")) {
    cities = (List<Cities>) request.getAttribute("delCityDetails");
...
<%
    ...
    <div class="alert alert-danger" style = "color:#a94442 !important; background-color: #f2dede !important; margin-bottom: 0px;">
        <strong>Problem deleting Record, Go back and try again</strong>
    </div>
    <%	
    }
    }catch(Exception e){
