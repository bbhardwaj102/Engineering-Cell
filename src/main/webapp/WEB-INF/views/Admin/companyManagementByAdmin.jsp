...
if (request.getAttribute("companiesReg") != null && !request.getAttribute("companiesReg").equals("")) {
    companies = (List<CompanyRegistrations>) request.getAttribute("companiesReg");
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<%
							Object[] executives = company.getExecutives();
							%>
							<td>
							<%
							for(Object ex : executives){
								Executive ee = (Executive)ex; 
							...
							for(Object ex : executives){
								Executive ee = (Executive)ex;
								out.println(ee.getDesignation() + ", ");
							}
							%>
							</td>
							<td><%=company.getRegDate() %></td>
							<%
							Object[] jobs = company.getJobDetails();
							%>
							<td>
							<%
							for(Object job : jobs){
								Job j = (Job)job;
								out.println(j.getDesignation() + ", ");
							}
							%>
							</td>
							<td>
							...
							for(Object job : jobs){
								Job j = (Job)job;
								out.println(j.getQualification() + ", ");
							}
							%>
							</td>
							<td>
