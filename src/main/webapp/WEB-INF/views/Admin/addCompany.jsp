...
if (request.getAttribute("addCompany") != null && !request.getAttribute("addCompany").equals("")) {
    companies = (List<Companies>) request.getAttribute("addCompany");
