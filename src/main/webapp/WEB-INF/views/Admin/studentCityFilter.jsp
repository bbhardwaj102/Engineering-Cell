...
if (request.getAttribute("studentCityFilterData") != null && !request.getAttribute("studentCityFilterData").equals("")) {
	registrations = (List<Registrations>) request.getAttribute("studentCityFilterData");
