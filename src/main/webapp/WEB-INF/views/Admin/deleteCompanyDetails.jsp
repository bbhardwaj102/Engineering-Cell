...
if (request.getAttribute("deleteCompany") != null && !request.getAttribute("deleteCompany").equals("")) {
    companies = (List<Companies>) request.getAttribute("deleteCompany");
...
<div class="modal fade" id="login-modal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  ...
  <div class="content-wrapper">
    ...
    <div class="alert alert-danger" style = "color:#a94442 !important; background-color: #f2dede !important; margin-bottom: 0px;">
        <strong>Record!</strong> Already Deleted, Go back and delete other records you want
    </div>
    <%	
    }
    }catch(Exception e){
