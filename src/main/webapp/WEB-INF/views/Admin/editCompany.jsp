...
if (request.getAttribute("editCompany") != null && !request.getAttribute("editCompany").equals("")) {
    companies = (List<Companies>) request.getAttribute("editCompany");
    ...
    <nav class="navbar navbar-static-top">
      ...
      <form id = "filterForm" action="<%= request.getContextPath()%>/admin/filterByCityDetails" class="form-inline" method = "get">
          <div class="form-group" style="margin-top:8px;">
              <select id = "addComDrop" name = "addComDrop" class = "form-control">
          ...
          <div class = "form-group" style = "margin-top: 8px;">
              <a href="#" class="btn btn-warning" role="button" data-toggle="modal" data-target="#login-modal" onclick = "setCity()">Add Company</a>
          </div>
...
<div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  ...
  <div class="modal fade" id="login-modal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    	<div class="modal-dialog">
			<div class="modal-content">
                ...
                <div id="div-forms">
                    <form id="editCom" method="post" autocomplete="off" action="<%= request.getContextPath()%>/admin/submitEditDetails">
		                <div class="modal-body">
		                    <input type = "hidden" id = "hidId" name = "hidId">
				    		<input id="updateCompanyName" name="updateCompanyName" class="form-control" type="text" placeholder="Edit Company Name" required>
				    		<input id = "updateCity" name = "updateCity" class = "form-control" type = "text" placeholder = "Edit City" required>
                            <input id="updateQualification" name="updateQualification" class="form-control" type="text" placeholder="Edit Qualificatio" required>
                            <input id="updateProfile" name="updateProfile" class="form-control" type="text" placeholder="Edit Profile" required>
                            <input id="updateCtc" name="updateCtc" class="form-control" type="text" placeholder="Edit CTC" required>
                            <input id="updateCriteria" name="updateCriteria" class="form-control" type="text" placeholder="Edit Criteria" required>
                            <input id="updateSelectionProcess" name="updateSelectionProcess" class="form-control" type="text" placeholder="Edit Selection Process" required>
                            <input id="updateDateOfCampus" name="updateCateOfCampus" class="form-control" type="text" placeholder="Edit Date Of Campus" required>
                            <input id="updateEligibility" name="updateEligibility" class="form-control" type="text" placeholder="Edit Eligibility" required>
        		    	</div>
				        <div class="modal-footer">
                            <div>
  ...
  <div class="content-wrapper">
    ...
    try{
    	...
    	if(companies != null && !flag){//model.addAttribute("", "true");
    %>
    ...
    <div class="alert alert-danger" style = "color:#a94442 !important; background-color: #f2dede !important; margin-bottom: 0px;">
        <strong>Error!</strong> Editing Record, please go back and try again
    </div>
    <%	
    }
    }catch(Exception e){
				...
				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover">
						...
						<tr>
							...
							<div class = "form-group" style = "margin-top: 8px;">
							    <a href="#" class="btn btn-warning" id = "aId" value = "45" role="button" data-toggle="modal" data-target="#login-modal2" onclick = 'editDetails("<%=company.getId()%>", "<%=company.getCompanyName() %>", "<%=company.getCity().toUpperCase() %>", "<%=company.getQualification() %>", "<%=company.getProfile() %>", "<%=company.getCtc() %>", "<%=company.getCriteria() %>", "<%=company.getSelectionProcess() %>", "<%=company.getDateOfCampus() %>", "<%=company.getEligibility() %>")' style = "padding:19px; padding-top:6px; padding-bottom:6px;">Edit</a>
							</div>
							</td>
						    </form>
