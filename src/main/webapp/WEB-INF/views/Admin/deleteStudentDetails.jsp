...
if (request.getAttribute("delStudentDetails") != null && !request.getAttribute("delStudentDetails").equals("")) {
	registrations = (List<Registrations>) request.getAttribute("delStudentDetails");
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    try{
    	...
    	if(registrations != null && !flag){//model.addAttribute("", "true");
    	%>
